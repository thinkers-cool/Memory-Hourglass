  ...
  it("shows progress over flash and context", () => {
    expect(
      resolveSystemStatus({
        ...
        roots,
        exportActive: true,
        exportProgress: { done: 1, total: 5, phase: "running", message: "export" },
        notification: successNotification("Tagged 2 item(s)"),
        busy: false,
      }),
    ).toBe("Export 1/5");
  ...
  it("shows export progress when running", () => {
    expect(
      resolveSystemStatus({
        ...
        roots,
        exportActive: true,
        exportProgress: { done: 2, total: 10, phase: "running", message: "export" },
        notification: null,
        busy: false,
      }),
    ).toBe("Export 2/10");
  ...
  it("shows export progress without file name", () => {
    expect(
      resolveProgressStatus({
        ...
        roots,
        exportActive: true,
        exportProgress: { done: 2, total: 4, phase: "running", message: "export" },
        notification: null,
        busy: false,
      })?.text,
    ).toBe("Export 2/4");
