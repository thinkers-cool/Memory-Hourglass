...
#[tauri::command]
pub async fn list_smb_shares(request: SmbListRequest) -> Result<Vec<SmbShareEntry>> {
    trace_command("list_smb_shares", || async move {
...
pub async fn mount_smb_for_browse(
    ...
    trace_command("mount_smb_for_browse", || async move {
        state
