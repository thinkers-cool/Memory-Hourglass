...
impl Catalog {
    ...
    pub fn from_pool(pool: SqlitePool) -> Self {
        ...
        Self {
            ...
            pools: CatalogPools::from_single(pool),
    ...
    pub async fn open(db_path: &Path) -> Result<Self> {
        ...
        Ok(Self {
            ...
            pools: CatalogPools::open(db_path).await?,
    ...
    pub fn pools(&self) -> &CatalogPools {
    ...
    pub fn assets(&self) -> AssetRepo {
        ...
        AssetRepo::new(self.pools.clone())
    ...
    pub fn asset_meta(&self) -> AssetMetaRepo {
        ...
        AssetMetaRepo::new(self.pools.clone())
    ...
    pub fn raw_tags(&self) -> RawTagRepo {
        ...
        RawTagRepo::new(self.pools.clone())
    ...
    pub fn collection(&self) -> crate::collection::CollectionRepo {
        ...
        crate::collection::CollectionRepo::new(self.pools.clone())
